...
/**
 * Copied from @url{http://www.labbookpages.co.uk/audio/javaWavFiles.html}.
 * With some modifications and removal of unneeded parts.
 */
    ...
    public static WavFile openWavFile(File file) throws IOException, WavFileException {
        ...
        while (true) {
            ...
            if (chunkID == FMT_CHUNK_ID) {
                ...
                if (compressionCode != 1 && compressionCode != 65534) // Ardour export => 1, sox output => 65534
